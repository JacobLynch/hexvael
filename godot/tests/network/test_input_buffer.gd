...
func test_add_and_drain_inputs():
	_buffer.add_input(1, {
		"tick": 10, "move_direction": Vector2.RIGHT, "aim_direction": Vector2.RIGHT, "input_seq": 1,
	})
	_buffer.add_input(1, {
		"tick": 10, "move_direction": Vector2.UP, "aim_direction": Vector2.RIGHT, "input_seq": 2,
	})
...
func test_inputs_sorted_by_sequence():
	_buffer.add_input(1, {
		"tick": 10, "move_direction": Vector2.RIGHT, "aim_direction": Vector2.RIGHT, "input_seq": 3,
	})
	_buffer.add_input(1, {
		"tick": 10, "move_direction": Vector2.UP, "aim_direction": Vector2.RIGHT, "input_seq": 1,
	})
	_buffer.add_input(1, {
		"tick": 10, "move_direction": Vector2.LEFT, "aim_direction": Vector2.RIGHT, "input_seq": 2,
	})
	var inputs = _buffer.drain_inputs_for_player(1)
...
func test_separate_players():
	...
	_buffer.add_input(2, {
		"tick": 10, "move_direction": Vector2.LEFT, "aim_direction": Vector2.RIGHT, "input_seq": 1,
	})
	var p1 = _buffer.drain_inputs_for_player(1)
	var p2 = _buffer.drain_inputs_for_player(2)
	assert_eq(p1.size(), 1)
	assert_eq(p2.size(), 1)
	assert_eq(p1[0]["move_direction"], Vector2.RIGHT)
	assert_eq(p2[0]["move_direction"], Vector2.LEFT)
